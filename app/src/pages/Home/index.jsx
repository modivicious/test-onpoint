  ...
  return (
    <div className={`${styles.wrapper} backgroundImage`}>
      ...
      <img
        ...
        src={require("../../../images/content/HomePage/1.png")}
        alt=""
      />
      <img
        className={`${styles.decorImg} ${styles.decorImg2}`}
        src={require("../../../images/content/HomePage/2.png")}
        alt=""
      />
      <img
        className={`${styles.decorImg} ${styles.decorImg3}`}
        src={require("../../../images/content/HomePage/3.png")}
        alt=""
      />
      <img
        className={`${styles.decorImg} ${styles.decorImg4}`}
        src={require("../../../images/content/HomePage/4.png")}
        alt=""
      />
      <img
        className={`${styles.decorImg} ${styles.decorImg5}`}
        src={require("../../../images/content/HomePage/5.png")}
        alt=""
      />
      <img
        className={`${styles.decorImg} ${styles.decorImg6}`}
        src={require("../../../images/content/HomePage/6.png")}
        alt=""
      />
      <img
        className={`${styles.decorImg} ${styles.decorImg7}`}
        src={require("../../../images/content/HomePage/7.png")}
        alt=""
      />
      <img
        className={`${styles.decorImg} ${styles.decorImg8}`}
        src={require("../../../images/content/HomePage/8.png")}
        alt=""
      />
      <img
        className={`${styles.decorImg} ${styles.decorImg9}`}
        src={require("../../../images/content/HomePage/9.png")}
        alt=""
      />
    </div>
  );
